...
variable "platform_resource_group" {
  description = "Resource group to create which will contain created Azure resources on Common Resources"
  type        = string
}

variable "tenant_resource_group" {
  description = "Resource group to create which will contain created Azure resources on Tenant Resources"
  type        = string
